...
def build_conversation(tokenizer, question, first_reasoning=None):
    if first_reasoning is not None:
        ...
        system_prompt = "Please solve the following math problem step by step. Output only your full thinking process, and then summarize the final answer in \boxed{}."
        user_prompt = f"Question: {question}"
